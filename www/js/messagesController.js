...
/* Query controller */
.controller('queries',function($scope, $state, $http,MasterService,$filter,$ionicLoading, $ionicModal, $ionicPopup, AuthService , ListService){

  	    var user_id= localStorage.getItem('userId');	
		ListService.chatList(user_id,function(data) {
...
.controller('UserMessagesCtrl', ['$scope', '$rootScope', '$state',
  ...
  function($scope, $rootScope, $state, $stateParams, MockService,MasterService,
    $ionicActionSheet,$ionicPopup, $ionicScrollDelegate, $timeout, $interval,$ionicHistory) {
     ...
     $scope.receiver_id=$stateParams.id;
     $scope.name=$stateParams.name;
	 $scope.receiver_pic =  base_url+"images/"+$scope.name+"_"+$scope.receiver_id+".jpg";
 ...
 $scope.getMessages  = function() {
     ...
     var user_id=localStorage.getItem('userId');
	 var receiver_id=$scope.receiver_id;
 	       MasterService.getUserMessages(user_id,receiver_id,function(data) {
		   $scope.$apply(function () 
		    {
			  $scope.messages = data;
    ...
    $scope.sendMessage = function(message) {
	  ...
	  formdata.reciever_id = $scope.receiver_id;
